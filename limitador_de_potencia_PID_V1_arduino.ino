...
#include <cmsis_compiler.h> //coisa pra funcionar o PID
#include <cmsis_gcc.h> //coisa pra funcionar o PID
...
#define ansdelay 550 //coeficiente de atraso na resposta do limitador (mantido, mas não usado diretamente com PID)
